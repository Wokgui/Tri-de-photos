...
set "APPDIR=%~dp0"
set "TARGET=%~dp0lancer_triphotos_interne.bat"
...
rem Masque le lanceur technique pour qu'il ne reste qu'un LANCER_TRIPHOTOS visible.
attrib +h "%TARGET%"
...
echo Utilise LANCER_TRIPHOTOS : il affiche maintenant l'icone de Tri de photos.
pause
